...
Route::prefix('admin')->group(function () {
    Route::middleware(['superadmin'])->group(function () {
        ...
        Route::prefix('role-menu')->group(function() {
            ...
            Route::put('/{id}', [MenuController::class, 'sortMenu']);
        ...
        Route::prefix('usecase')->group(function() {
            ...
            Route::get('profile/{id}', [UsecaseController::class, 'getUsecaseProfileById']);
        ...
        Route::prefix('user')->group(function() {
            ...
            Route::put('active/{id}', [UserController::class, 'updateIsActived']);
        ...
        Route::prefix('content')->group(function() {
            Route::prefix('polygon')->group(function() {
                ...
                Route::put('{id}', [UsecaseController::class, 'updateUsecasePolygon']);
...
Route::prefix('dashboard')->group(function() {
    Route::middleware(['subadmin'])->group(function () {
        ...
        Route::prefix('usecase')->group(function() {
            Route::get('', [UsecaseController::class, 'getUserUsecase']);
            Route::get('profile', [UsecaseController::class, 'getUserProfile']);
            Route::put('profile', [UsecaseController::class, 'updateUserProfile']);
            Route::get('polygon', [UsecaseController::class, 'getUserPolygon']);
        });

        Route::prefix('user')->group(function() {
            Route::get('detail', [UserController::class, 'userDetail']);
            Route::post('subadmin', [UserController::class,'addSubAdmin']);
        });
        ...
        Route::prefix('visi-misi')->group(function() {
            Route::prefix('visi')->group(function() {
                Route::put('', [UsecaseController::class,'updateUserVisi']);
                Route::get('', [UsecaseController::class,'listUserVisi']);
            });
            Route::prefix('misi')->group(function() {
                Route::put('', [UsecaseController::class,'updateUserMisi']);
                Route::get('', [UsecaseController::class,'listUserMisi']);
            });
        });
